...
up:
	...
	sudo tailscale funnel --bg --tcp $$(grep '^HTTPS_PORT' jitsi/.env | awk -F= '{print $$2}') tcp://localhost:$$(grep '^HTTPS_PORT' jitsi/.env | awk -F= '{print $$2}')
...
down:
	...
	sudo tailscale funnel --bg --tcp $$(grep '^HTTPS_PORT' jitsi/.env | awk -F= '{print $$2}') tcp://localhost:$$(grep '^HTTPS_PORT' jitsi/.env | awk -F= '{print $$2}') off
